...
import { getUsersPreviousOrdersAPI } from '../../apis/common';
...
function PreviousOrders() {
    ...
    return (
        <div id='allUserNotifications_element' >
            <h4 className='ExploreStores-TotalresultNum'>{t("totol-results")} {totalOrders}</h4>
			{orders.map((order, i) => <PreviousOrdersCard key={i} order={order} />)}
