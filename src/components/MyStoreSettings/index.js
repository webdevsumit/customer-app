...
function MyStoreSettings() {
    ...
    return (
        <div className='MyStoreSettings'>
            <div className='MyStoreSettings-inline-inputs'>
                <div className='MyStoreSettings-inline-inputs2'>
                    <label className='MyStoreSettings-sub-input-label'>
                        {t("input-labels.lang")}
                    </label><br />
                    <select
                        className='MyStoreSettings-type-input'
                        name='lang'
                        value={lang}
